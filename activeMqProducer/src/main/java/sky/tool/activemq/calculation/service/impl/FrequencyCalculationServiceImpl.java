...
public class FrequencyCalculationServiceImpl extends AbstractCalculationService
{
	@Autowired
	...
	{
		redisUtil.set(getKeyPreFix(hre, jo) + HtywType.FREQUENCY.getEnglishName(), jo);
		logger.info(HtywType.FREQUENCY.getEnglishName() + " send");
	}
